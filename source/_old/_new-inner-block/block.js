...
registerBlockType('k-blocks-bs-new-parent/k-blocks', {
  title: __('BS NEW'),
    ...
    return wp.element.createElement(
      ...
      wp.element.createElement(
        ...
        wp.element.createElement(InnerBlocks, {
          allowedBlocks: ['k-blocks-bs-accordion-child/k-blocks'],
...
registerBlockType('k-blocks-bs-new-child/k-blocks', {
  title: __('Accordion Slide'),
  icon: SectionBlockIcon,
  category: 'k-common-blocks',
  parent: ['k-blocks-bs-new-parent'],
