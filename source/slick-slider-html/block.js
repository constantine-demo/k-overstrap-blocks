...
var _startBlockPlaceholder = require('../bs-grid/start-block-placeholder.js');
    ...
    return wp.element.createElement(
      ...
      wp.element.createElement(
        ...
        wp.element.createElement(
          ...
          wp.element.createElement(
            'div',
            { className: "k-blocks-slick-html-inner-content row" + addCenterClass(props) + addValignClass(props) + guttersClass },
            wp.element.createElement(InnerBlocks.Content, null)
          )
        )
      )
